...
export default {
  ...
  computed: {
    ...mapGetters("appOrder/saleOrder", ["persistCustomer"]),
    ...mapGetters("appOrder/saleCustomer", ["dataList"]),
  ...
  methods: {
    ...mapActions("appOrder/saleCustomer", ["queryPage", "addNextPage"]),
    ...mapMutations("appOrder/saleCustomer", ["queryParam"]),
    onRefresh() {
