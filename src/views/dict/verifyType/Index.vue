...
export default {
  ...
  computed: {
    ...mapGetters("appDict/verifyType", ["dataList", "perPersist"]),
  ...
  methods: {
    ...mapActions("appDict/verifyType", ["queryPage", "addNextPage"]),
    ...mapMutations("appDict/verifyType", ["queryParam"]),
    onRefresh() {
    ...
    persistData() {
      this.$router.push("/dict/verifyTypePersist");
    }
  }
};
</script>
